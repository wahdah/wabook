    ...
    <div class="row box summary-book">
        ...
        <div class="col-xs-8 col-sm-6">
            <div style="display:inline-block;">
                    <p style="font-weight:bold;width:300px;margin:0;float:left">Pay Amount :<br/><input type="text" name="amountbox" size="20" style="width: 200px;" value="" required  /></p>
                    <p style="font-weight:bold;width:250px;margin:0;float:left">Transaction Date : <br/>
                    <input type="text" id="datepick" placeholder="Date" name="date_transaction" value="" required /></p>
                </div>
            
            <div style="display:inline-block;float:left;padding-right:20px;font-weight:bold">
                    <p style="">From Bank :<br/> 
        ...
        <div class="col-xs-4 col-sm-6">
            <div style="font-weight:bold">
                ...
                <p>Transaction No/Reference No :<input type="text" name="transactionbox" size="20" style="width: 300px;" required /></p>
                </div>
                ...
                Proof of Payment :
                <input type="file" name="proof" accept=".jpg,.png,.pdf" required /></br>
            </div>
            ...
            <div class="btn_container">
                <input style="float:right" type="submit" id="ibutton" name="submitbtn" value="Submit" />
            </div>
